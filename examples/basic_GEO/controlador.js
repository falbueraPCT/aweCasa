        ...
        ready: function() {
            ...
            awe.util.require([
            {
                ...
                success: function() { 
                    ...
                    awe.pois.add({ id:'amposta', position: { x: poi1_lat*10000000, y: 0, z: poi1_lng*10000000 } });
                    ...
                    //if (new_place){
                        awe.povs.update({ data: { position: { x: pos.lat*10000000, y: 0, z: pos.lng*10000000 } }, where: { id: 'default' } });
                    //    new_place = false;
                    //}
